...
public:
	...
	bool place_car(char a_name, size_t a_length, bool a_orientation, struct Coordinates a_loctaion);
	bool move_car(char a_name, char a_direction);
	bool is_victory();
...
//	void operator[](size_t a_row);
	...
	bool check_direction_vailidity(char a_name, char a_direction);
	Coordinates get_new_location(char a_name, char a_direction);
	void set_car_location(char a_name, struct Coordinates newLocation);
	void change_location_on_board(char a_name, char a_direction);
