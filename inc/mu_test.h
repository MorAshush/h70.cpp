...
__fine__ __FUNTASTICUSZ mt__EXPECTED_p(void* a, void* e,MT_SYMBOL xx,MT_SYMBOL zz){char* p = (char*) malloc(1024);if(p) sprintf(p,mt__ACTUALL "%p\n\t\t\t"  mt__EXPECTED "%p",a,e);(void)xx;(void)zz;MT__GIVE p;}
...
_____ _____ _____ _____ _____ _____ _____ _____    clock_t __time_spent; clock_t __begin,__end;struct mt__AssertResult __r;int sgu1;\
